...
class Material(Base):
    ...
    matches: Mapped[list["MaterialMatch"]] = relationship("MaterialMatch", back_populates="material")
...
class MaterialMatch(Base):
    ...
    storyboard: Mapped["Storyboard"] = relationship("Storyboard", back_populates="matches")
    material: Mapped["Material"] = relationship("Material", back_populates="matches")
